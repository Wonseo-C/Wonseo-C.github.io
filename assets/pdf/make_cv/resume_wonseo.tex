...
\begin{rSection}{Research Project}
	...
	\begin{rSubsection}{Additional Projects}{}{}{}
...
<<<<<<< HEAD
		\item ARe-architected an automated analysis system from R to Python (Polars), optimizing data processing speed and system stability.
		\item Established an end-to-end MLOps pipeline for auto-tuning systems to automate model deployment and ensure production quality.
=======
		\item Re-architected an automated analysis system from R to \textbf{Python (Polars)}, optimizing data processing speed and system stability.
		\item Established an end-to-end \textbf{MLOps pipeline} for auto-tuning systems to automate model deployment and ensure production quality.
		
>>>>>>> b6d9e0e92333e540a0cad0576f2d930e971df8eb
		\item Developed and deployed ML-based yield prediction models, leveraging big data to enhance manufacturing efficiency.
		\item Optimized large-scale data processing workflows using R and Python to identify and mitigate yield loss factors.
	\end{rSubsection}
...
\begin{rSection}{Technical Strengths}
    \begin{tabular}{@{} >{\bfseries}l @{\hspace{6ex}} l @{}}
        Data Engineering & \textbf{Python (Polars, Pandas)}, R, SQL, Spark \\
        Machine Learning & \textbf{MLOps System Design}, PyTorch, TensorFlow, Keras, Scikit-learn \\
        Programming Tools & MATLAB, Assembly, Java, C++, TypeScript \\
        Environments & Linux (Ubuntu Server), Docker, Git, Mac/Windows
    \end{tabular}
\end{rSection}
